...
import com.reputation.demo.model.Data;
...
public class FundService {
	...
	public List<ResponseData> getFundData(String fundId, String horizon, String periodOfInvestement) {
		FundData fundDetails = httpservice.getResponse(fundId);
		List<Data> rawDataList = fundDetails.getData();
		Map<String, String> mapdata = new HashMap<String, String>();
		for (Data data : rawDataList)
			mapdata.put(data.getDate(), data.getNav());
		return calculateReturns(mapdata, horizon, periodOfInvestement);
	}
